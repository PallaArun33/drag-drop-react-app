...
const AgentSidebar = ({ onDragStart }) => {
  ...
  return (
    <div className="agent-sidebar rounded-lg border border-gray-200 shadow-sm">
      {/* Top Expand Icon */}
      <div
        className="cursor-pointer p-2 rounded-t-lg hover:bg-gray-100 transition-all duration-200 flex justify-center items-center"
        onClick={scrollUp}
      >
      ...
      {/* Bottom Expand Icon */}
      <div
        className="cursor-pointer rounded-b-lg p-2 hover:bg-gray-100 transition-all duration-200 flex justify-center items-center"
        onClick={scrollDown}
      >
